...
import {
  ...
  ArrowLeftRight, Building2, Settings,
...
const companyNav: NavItem[] = [
  ...
  { href: '/operacao',         label: 'Opera̵̤es',       icon: Shield },
  { href: '/compliance/kyc',   label: 'Verifica̤̣o KYC', icon: FileCheck },
...
const procuradorNav: NavItem[] = [
  ...
  { href: '/marketplace',       label: 'Cr̩ditos',      icon: DollarSign },
  { href: '/demandas',          label: 'Demandas',      icon: TrendingUp },
  { href: '/pipeline',          label: 'Pipeline',      icon: GitMerge },
  { href: '/assessor/clientes', label: 'Meus Clientes', icon: Users },
  { href: '/assessor/comissoes',label: 'Comiss̵es',     icon: Wallet },
