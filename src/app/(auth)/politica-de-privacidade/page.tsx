      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-sm font-semibold text-white mt-4 mb-2">2.1. Dados fornecidos pelo Usuário:</h3>
            ...
            <h3 className="text-sm font-semibold text-white mt-4 mb-2">2.2. Dados coletados automaticamente:</h3>
            <ul className="list-disc list-inside space-y-1 text-slate-400">
            ...
            <h3 className="text-sm font-semibold text-white mt-4 mb-2">2.3. Dados transacionais:</h3>
            <ul className="list-disc list-inside space-y-1 text-slate-400">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1 text-slate-400">
              <li><strong className="text-slate-300">Consentimento</strong> (Art. 7º, I): para coleta de dados no cadastro</li>
              <li><strong className="text-slate-300">Execução de contrato</strong> (Art. 7º, V): para operacionalização das transações</li>
              <li><strong className="text-slate-300">Cumprimento de obrigação legal</strong> (Art. 7º, II): para atendimento de exigências fiscais e tributárias</li>
              <li><strong className="text-slate-300">Legítimo interesse</strong> (Art. 7º, IX): para prevenção de fraudes e melhoria da Plataforma</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">7. Direitos do Titular</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-3">9. Encarregado de Dados (DPO)</h2>
            <p>
