          ...
          <div className="flex items-center flex-1 min-w-0">
            ...
            <div className="hidden lg:flex relative pl-6">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-72 rounded-xl bg-dark-700 border border-dark-500/50 text-sm text-slate-900 placeholder-slate-500 focus:bg-dark-600 focus:border-brand-500/50 focus:ring-2 focus:ring-brand-500/20 transition-all outline-none"
              />
            </div>
          </div>
        ...
        <footer className="hidden lg:flex border-t border-dark-500/30 px-6 py-3 mt-auto">
          <div className="flex items-center justify-between w-full text-[11px] text-slate-600">
            ...
            <div className="flex items-center gap-4">
              <a href="/termos-de-uso" target="_blank" className="hover:text-slate-500 transition-colors">Termos de Uso</a>
              <a href="/politica-de-privacidade" target="_blank" className="hover:text-slate-500 transition-colors">Política de Privacidade</a>
              <a href="/institucional" className="hover:text-slate-500 transition-colors">Quem Somos</a>
            </div>
          </div>
        </footer>
      </main>
